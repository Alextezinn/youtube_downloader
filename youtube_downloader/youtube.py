...
class YouTubeVideoDownloaderHighestResolution(YouTube):
    ...
    def download_video(self, filename: Optional[str]=None, output_path: Optional[str]=None) -> None:
    ...
    def merge_audio_with_video(videofile: str="name.mp4",
        ...
        command_cmd = f"ffmpeg -y -i \"{videofile}\" -i \"{audiofile}\" -map 0:v -map 1:a -c copy -strict -2 \"{outputfile}\" -nostdin"
